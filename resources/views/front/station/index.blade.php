...
@section('subtitle', 'List Stations')
@section('content')
                    ...
                    <div class="single-blog-post-wrap aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                        <div class="blog-thumbnail">
                            <a href="/front/station/{{$station->id}}">
                                <img class="fit-image" src="{{$station->banner}}" alt="{{$station->name}}">
                        ...
                        <div class="blog-post-details pt-5">
                            ...
                            <div class="post-meta mb-3 mt-3">
                                ...
                                <span><i class="fa fa-clock-o"></i> {{$station->created_at->diffForHumans()}}</span>
                            </div>
                            <p class="desc-content mb-2 mb-md-5">{{\Illuminate\Support\Str::substr($station->detail,0,300)}}</p>
                            <a href="/front/station/{{$station->id}}" class="btn btn-hover-primary read-more">Keep Reading</a>
                        </div>
                    </div>
            ...
            @endforeach
                    ...
                    <div class="single-blog-post-wrap aos-init" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="blog-post-details pt-5">
                            ...
                            <div class="post-meta mb-3 mt-3">
                                <a href="#"><i class="fa fa-user"></i> Admin</a>
                                <span><i class="fa fa-clock-o"></i> {{$station->created_at}}</span>
                            </div>
                            <p class="desc-content mb-2 mb-md-5">{{$station->detail}}</p>
                            <a href="/front/station/{{$station->id}}" class="btn btn-hover-primary read-more">Keep Reading</a>
                        </div>
                    </div>
                    <!-- Single Blog Post End -->
